...
This Challenge involved looking at backup pages to find out how authentication worked on *http://verbal-sleep.picoctf.net:58281/impossibleLogin.php* adding a "~" to the end of the url shows a backup of the page that was stored during the development process and inspecting the html I found this blob of php "**?php
...
pdf1 = urllib.request.urlopen("http://shattered.io/static/shattered-1.pdf").read()
pdf2 = urllib.request.urlopen("http://shattered.io/static/shattered-2.pdf").read()
